	...
	return (
		<div className="p-4 bg-[#fff]">
			<div className="flex relative">
				<button ref={prevRef} className="z-10 absolute p-2 bg-[#fff] rounded-[50%] top-[50%] left-[10px]">
					<IoIosArrowBack />
				</button>
				<Swiper
					spaceBetween={30}
				...
				>
					<SwiperSlide>
						<div className="grid grid-cols-2 gap-4">
							<img
								className="rounded-[12px] border-[1px] border-solid border-[#0000000d]"
				...
				<button ref={nextRef} className="z-10 absolute p-2 bg-[#fff] rounded-[50%] top-[50%] right-[10px]">
					<IoIosArrowForward />
				</button>
			</div>
		</div>
